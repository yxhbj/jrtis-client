...
function loadData(data){
  ...
  document.querySelector('#backupLockedOnly').checked=data.backup.backupLockedOnly==1?true:false
  document.querySelector('#showBN').innerHTML = document.querySelector('[name="backupNumberPerDay"]').value;
  document.querySelector('#showCapacity').innerHTML = document.querySelector('[name="capacityUpperLimit"]').value+'%';
}
...
function setEventListeners(){
  ...
  document.querySelector('[name="backupNumberPerDay"]').addEventListener('input', function () {
    document.querySelector('#showBN').innerHTML = this.value;
  })
  document.querySelector('[name="backupNumberPerDay"]').addEventListener('change', function () {
    document.querySelector('#showBN').innerHTML = this.value;
  })
  document.querySelector('[name="capacityUpperLimit"]').addEventListener('input', function () {
    document.querySelector('#showCapacity').innerHTML = this.value+'%';
  })
  document.querySelector('[name="capacityUpperLimit"]').addEventListener('change', function () {
    document.querySelector('#showCapacity').innerHTML = this.value+'%';
  })
  document.querySelector('#autoDeletePatient').addEventListener('change', function () {
    if (this.checked){
  ...
  document.querySelector('#backupLockedOnly').addEventListener('change', function () {
    document.querySelector('[name="backupLockedOnly"]').value=this.checked?1:0
  })
}